...
export const emailIntegrations: Integration[] = [
  {
    ...
    logoUrl: 'https://static.cdnlogo.com/logos/o/14/official-gmail-icon-2020.svg',
    status: 'available',
...
export const getAvailableIntegrations = (): Integration[] => {
  return allIntegrations.filter((integration) => integration.status === 'available');
};

export const getComingSoonIntegrations = (): Integration[] => {
  return allIntegrations.filter((integration) => integration.status === 'coming_soon');
};
