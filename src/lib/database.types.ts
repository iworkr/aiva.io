  ...
  public: {
    Tables: {
      ...
      auto_send_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "auto_send_log_draft_id_fkey"
            columns: ["draft_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "auto_send_log_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auto_send_log_queue_id_fkey"
            columns: ["queue_id"]
            isOneToOne: false
            referencedRelation: "auto_send_queue"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "auto_send_log_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      auto_send_queue: {
        ...
        Relationships: [
          {
            foreignKeyName: "auto_send_queue_connection_id_fkey"
          ...
          {
            foreignKeyName: "auto_send_queue_draft_id_fkey"
            columns: ["draft_id"]
            isOneToOne: false
            referencedRelation: "message_drafts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auto_send_queue_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "messages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auto_send_queue_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
