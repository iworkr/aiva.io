      ...
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Text style={textStyle}>
            Unfortunately, {appName} could not complete your generation request. You can try again using the link below.
          </Text>
          <Button href={retryLink} style={buttonStyle}>Try Again</Button>
          <Hr style={hrStyle} />
          <Text style={textStyle}>
            If the issue persists, reach out to <Link href={`mailto:${supportEmail}`} style={linkStyle}>{supportEmail}</Link>.
          </Text>
